...
from app.routers.projects import sanitize_filename, validate_mime_type, create_project_request, get_project_count
...
class TestProjectsUnit(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_project_count(self):
        ...
        with patch('app.routers.projects.supabase') as mock_supabase:
            ...
            mock_supabase.table.return_value.select.return_value.eq.return_value.neq.return_value.execute.return_value = mock_count_response
